...
public class ActivitiesController extends BaseController {
    ...
    public R getPageInfos(Long pageIndex, Long pageSize,
                          String token, String activeName, String teamName) {
        ...
        if (user.getType() == 0) {
            ...
            Log.info("分页查找活动信息，当前页码：{}，"
                            + "每页数据量：{}, 模糊查询，活动名称：{}，社团名称：{}", pageIndex,
                    pageSize, activeName, teamName);

            PageData page = activitiesService.getPageAll(pageIndex, pageSize, activeName, teamName);
            ...
            PageData page = activitiesService.getPageByUserId(pageIndex, pageSize, user.getId(), activeName, teamName);
